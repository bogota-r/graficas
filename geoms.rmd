...
data.example=data.frame(x=c(1,2,5,6,8), y=c(3,6,2,8,7), vx=c(1,1.5,0.8,0.5,1.3), vy=c(0.2,1.3,1.7,0.8,1.4))

theme_update(plot.background = element_rect(fill = "transparent", colour = "transparent"))
