...
## `r geom_slide_title("geom_violin")`

```{r geom_violin}
ggplot(mtcars) + aes(y = mpg, x = factor(cyl)) + geom_violin()
```

## `r geom_slide_title("geom_dotplot")`
...
## `r geom_slide_title("geom_boxplot")`

```{r geom_boxplot}
ggplot(mtcars) + aes(factor(cyl), mpg) + geom_boxplot()
```

## `r geom_slide_title("geom_bar")`
...
## `r geom_slide_title("geom_bin2d")`

```{r geom_bin2d}
ggplot(diamonds) + aes(price, depth)   + geom_bin2d()
```

## `r geom_slide_title("geom_hex")`
...
## `r geom_slide_title("geom_jitter")`
...
## `r geom_slide_title("geom_quantile")`

```{r geom_quantile}
ggplot(mpg) + aes(displ, hwy) + geom_point() + geom_quantile()
```

## `r geom_slide_title("geom_smooth")`

```{r geom_smooth}
ggplot(mpg) + aes(displ, hwy) + geom_point() + geom_smooth()
```

## `r geom_slide_title("geom_density2d")`
...
## `r geom_slide_title("geom_density")`

```{r geom_density}
ggplot(mtcars) + aes(x = mpg) + geom_density()
```

## `r geom_slide_title("geom_freqpoly")`

```{r geom_freqpoly}
ggplot(mtcars) + aes(x = mpg) + geom_freqpoly(binwidth = 2)
```

## `r geom_slide_title("geom_histogram")`
...
```{r colmap, img.link = "http://github.com/nebulae-co/colmaps"}
print(colombia)
```
