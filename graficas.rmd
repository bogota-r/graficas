...
* Es considerado como una implementación de los principios generales de las gráficas *Trellis*.
...
parallel()    | Gráfica de coordenadas paralelas       | `data.frame`        |
...
```{r lattice, echo = FALSE}
xyplot(LECTURA_CRITICA_PUNT ~ MATEMATICAS_PUNT | factor(FINS_ESTRATOVIVIENDAENERGIA) * factor(PERS_GENERO),
            data = SB11_20142, xlab = "Puntaje Matemáticas", ylab = "Puntaje Lectura Crítica")
```
